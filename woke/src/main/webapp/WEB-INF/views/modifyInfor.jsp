	...
	<div class="easyui-tabs" style="width:850px;height:600px;">
		<div title="修改密码"  style="padding:10px;" >
			<div class="w" id="regist" style="width:830px;">
				<div class="mc">
					<form method="post"  action="<%=request.getContextPath()%>/showhostinfor" class="form-actions" target="_bank" onsubmit="return CheckForm();">
						<div class="form">
					        <div class="item">
				 ...
				 <div class="w" id="regist" style="width:830px;">
					<div class="mc">
						<form method="post"  class="form-actions"
							action="<%=request.getContextPath()%>/showhostinfor" target="iframepage">
							<div class="form">
								<div class="item">
									<span class="label"><b class="ftx04">*</b>昵称：</span>
									<div class="fl item-ifo">
