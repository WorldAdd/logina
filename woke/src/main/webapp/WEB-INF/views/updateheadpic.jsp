...
<body>
	<div class="inner">
		...
		<div class="infos">
		<div id="localImag"><center><img src="static/headpic/${user1.headpic}" width="80" height="80" name="pic"/></center></div>  
			<br><br>
			<center>
			 <form action="<%=path%>/updateheadpic" method="post" enctype="multipart/form-data" target="header">
